#line 1 "C:\Program Files (x86)\SEGA\PHANTASYSTARONLINE2\pso2_bin\reshade-shaders\Shaders\Layer2.fx"
...
> = 0.5;
#line 63
texture Layer_Two_texture <source="Layer2.png" ;> { Width = 1920; Height = 1080; Format=RGBA8; };
...
const float2 scale = 1.0 / (float2(1920, 1080) / ReShade::ScreenSize * Layer_Two_Scale);
